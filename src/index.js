...
import { addScheduleHandler, getScheduleHandler, listPackagesHandler, notifypaymentHandler, updatePackagesHandler, verifyPackagePaymentHandler } from './handlers/package.js';
...
app.post('/packages/type/payment/notify', commonAuth, notifypaymentHandler)
